...
export const ideas: Idea[] = [
  { id: 'i1', code: 'IDEA-2025-001', title_ar: 'منصة موحدة لرصد الأسعار', title_en: 'Unified price monitoring platform', problem_statement: 'Price signals are fragmented across sectors.', proposed_solution: 'A central data pipeline aggregating retail prices.', category: 'market_monitoring', strategic_theme_id: 't1', activity_id: 'a2', status: 'benefits_tracking', current_stage: 8, submitter_id: 'u2', confidentiality: 'internal', source: 'new', created_at: '2025-01-12' },
  { id: 'i2', code: 'IDEA-2025-002', title_ar: 'مؤشر تركز السوق الآلي', title_en: 'Automated market concentration index', problem_statement: 'Manual HHI calculation is slow.', proposed_solution: 'Automated HHI computation from filings.', category: 'analytics', strategic_theme_id: 't3', activity_id: 'a2', status: 'in_implementation', current_stage: 7, submitter_id: 'u5', confidentiality: 'internal', source: 'new', created_at: '2025-01-18' },
  { id: 'i3', code: 'IDEA-2025-003', title_ar: 'بوابة بلاغات تجار التجزئة', title_en: 'Retailer complaints portal', problem_statement: 'SMEs lack an easy complaint channel.', proposed_solution: 'A guided bilingual complaint intake portal.', category: 'services', strategic_theme_id: 't2', activity_id: 'a1', status: 'in_pilot', current_stage: 6, submitter_id: 'u7', confidentiality: 'public', source: 'new', created_at: '2025-02-02' },
  { id: 'i4', code: 'IDEA-2025-004', title_ar: 'نموذج كشف التواطؤ بالذكاء الاصطناعي', title_en: 'AI bid-rigging detection model', problem_statement: 'Bid rigging is hard to detect manually.', proposed_solution: 'ML model flagging suspicious bidding patterns.', category: 'enforcement', strategic_theme_id: 't1', activity_id: 'a1', status: 'assigned', current_stage: 5, submitter_id: 'u8', confidentiality: 'confidential', source: 'new', created_at: '2025-02-08' },
  { id: 'i5', code: 'IDEA-2025-005', title_ar: 'تبسيط إجراءات الاندماج', title_en: 'Simplified merger filing', problem_statement: 'Merger filings are paperwork-heavy.', proposed_solution: 'A digital wizard for merger notifications.', category: 'process', strategic_theme_id: 't3', activity_id: 'a2', status: 'committee', current_stage: 4, submitter_id: 'u6', confidentiality: 'internal', source: 'new', created_at: '2025-02-11' },
  { id: 'i6', code: 'IDEA-2025-006', title_ar: 'لوحة شفافية القرارات', title_en: 'Decisions transparency dashboard', problem_statement: 'Public has limited visibility of rulings.', proposed_solution: 'A public dashboard of anonymized decisions.', category: 'transparency', strategic_theme_id: 't3', activity_id: 'a2', status: 'evaluation', current_stage: 4, submitter_id: 'u2', confidentiality: 'public', source: 'new', created_at: '2025-02-14' },
  { id: 'i7', code: 'IDEA-2025-007', title_ar: 'برنامج توعية المنشآت الناشئة', title_en: 'Startup awareness program', problem_statement: 'Startups unaware of competition rules.', proposed_solution: 'Workshops and a self-assessment toolkit.', category: 'education', strategic_theme_id: 't2', activity_id: 'a1', status: 'evaluation', current_stage: 4, submitter_id: 'u7', confidentiality: 'public', source: 'new', created_at: '2025-02-17' },
  { id: 'i8', code: 'IDEA-2025-008', title_ar: 'واجهة برمجية للبيانات المفتوحة', title_en: 'Open data API', problem_statement: 'Researchers can not access aggregate data.', proposed_solution: 'A documented open-data API.', category: 'data', strategic_theme_id: 't1', activity_id: 'a1', status: 'screening', current_stage: 3, submitter_id: 'u8', confidentiality: 'public', source: 'new', created_at: '2025-02-20' },
  { id: 'i9', code: 'IDEA-2025-009', title_ar: 'تحليل شكاوى المستهلكين', title_en: 'Consumer complaint analytics', problem_statement: 'Complaints are not analyzed at scale.', proposed_solution: 'NLP clustering of complaints.', category: 'analytics', strategic_theme_id: 't1', activity_id: 'a2', status: 'screening', current_stage: 3, submitter_id: 'u4', confidentiality: 'internal', source: 'new', created_at: '2025-02-22' },
  { id: 'i10', code: 'IDEA-2025-010', title_ar: 'مساعد افتراضي للأنظمة', title_en: 'Regulations virtual assistant', problem_statement: 'Staff search regulations manually.', proposed_solution: 'A retrieval assistant over the legal corpus.', category: 'knowledge', strategic_theme_id: 't3', activity_id: 'a2', status: 'submitted', current_stage: 1, submitter_id: 'u3', confidentiality: 'internal', source: 'new', created_at: '2025-02-25' },
  { id: 'i11', code: 'IDEA-2025-011', title_ar: 'مؤشر صحة المنافسة القطاعي', title_en: 'Sector competition health index', problem_statement: 'No single sector health metric.', proposed_solution: 'Composite index per sector.', category: 'analytics', strategic_theme_id: 't1', activity_id: 'a2', status: 'submitted', current_stage: 1, submitter_id: 'u5', confidentiality: 'internal', source: 'new', created_at: '2025-02-27' },
  { id: 'i12', code: 'IDEA-2025-012', title_ar: 'نظام تتبع الالتزام', title_en: 'Compliance tracking system', problem_statement: 'Hard to track remedy commitments.', proposed_solution: 'A commitments register with reminders.', category: 'process', strategic_theme_id: 't3', activity_id: 'a2', status: 'draft', current_stage: 0, submitter_id: 'u6', confidentiality: 'internal', source: 'new', created_at: '2025-03-01' },
  { id: 'i13', code: 'IDEA-2025-013', title_ar: 'حملة توعية المستهلك', title_en: 'Consumer awareness campaign', problem_statement: 'Consumers unaware of their rights.', proposed_solution: 'A multi-channel awareness campaign.', category: 'education', strategic_theme_id: 't2', activity_id: 'a1', status: 'approved', current_stage: 5, submitter_id: 'u7', confidentiality: 'public', source: 'new', created_at: '2025-03-03' },
  { id: 'i14', code: 'IDEA-2025-014', title_ar: 'أرشفة القضايا التاريخية', title_en: 'Legacy case archiving', problem_statement: 'Old cases are on paper.', proposed_solution: 'Digitize and index legacy cases.', category: 'data', strategic_theme_id: 't3', activity_id: 'a2', status: 'closed', current_stage: 8, submitter_id: 'u2', confidentiality: 'internal', source: 'legacy_migration', created_at: '2024-11-05' },
  { id: 'i15', code: 'IDEA-2025-015', title_ar: 'مختبر تنظيمي للأسواق الرقمية', title_en: 'Digital markets regulatory lab', problem_statement: 'Need safe testing of new rules.', proposed_solution: 'A sandbox to pilot regulatory measures.', category: 'policy', strategic_theme_id: 't1', activity_id: 'a1', status: 'returned', current_stage: 4, submitter_id: 'u8', confidentiality: 'internal', source: 'new', created_at: '2025-03-04' },
];
