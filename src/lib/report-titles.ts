...
export const TITLE_DEFAULTS: Record<string, ReportTitle> = {
  ...
  kpi_total_ideas: {
    key: 'kpi_total_ideas',
    title_ar: 'إجمالي الأفكار',
    title_en: 'Total Ideas',
    subtitle_ar: null,
    subtitle_en: null,
  },
  kpi_approved: {
    key: 'kpi_approved',
    title_ar: 'الأفكار المعتمدة',
    title_en: 'Approved Ideas',
    subtitle_ar: null,
    subtitle_en: null,
  },
  kpi_avg_score: {
    key: 'kpi_avg_score',
    title_ar: 'متوسط درجة التقييم',
    title_en: 'Average Evaluation Score',
    subtitle_ar: null,
    subtitle_en: null,
  },
  kpi_committee_decisions: {
    key: 'kpi_committee_decisions',
